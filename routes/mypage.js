  ...
  Reservation.findAll({
    ...
    Space.findAll({
      ...
      r.forEach((reservation) => {
        ...
        reservation.dataValues.startTimeString = periods[reservation.startperiodnum].startTimeString;
        reservation.dataValues.endTimeString = periods[reservation.endperiodnum].endTimeString;
